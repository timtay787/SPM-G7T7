...
create table SBRP_DB.role_listings
...
constraint role_listings_fk foreign key (Role_ID) references role_details(Role_ID),
constraint role_listings_fk2 foreign key (Role_Listing_Source) references staff_details(Staff_ID),
constraint role_listings_fk3 foreign key (Role_Listing_Creator) references staff_details(Staff_ID),
constraint role_listings_fk4 foreign key (Role_Listing_Updater) references staff_details(Staff_ID));

-- insert data into role_listings table
INSERT INTO SBRP_DB.role_listings VALUES
...
-- create application table
create table SBRP_DB.role_application
(role_app_id int not null auto_increment primary key,
role_listing_id int not null,
staff_id int not null,
role_app_status ENUM('applied', 'withdrawn') not null,
...
constraint role_application_fk foreign key (role_listing_id) references role_listings(Role_Listing_ID),
constraint role_application_fk2 foreign key (staff_id) references staff_details(Staff_ID));

-- insert data into role_application table
-- INSERT INTO SBRP_DB.role_application VALUES
