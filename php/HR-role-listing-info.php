...
<<<<<<< Updated upstream:HR-role-listing-info.php
=======
...
>>>>>>> Stashed changes:php/HR-role-listing-info.php
</head>
...
=======
                        <tr v-for="staff_application of staff_applications">
                          ...
                          <td><button type="button" v-bind:name="staff_application.staff.StaffID" onclick="location.href = 'HR-staff-profile.php'; sessionStorage.setItem('staff_id', name)" class="btn btn-primary">View Profile</button><p> </p>
                          <button type="button" v-bind:name="staff_application.application.RoleApplicationID" onclick="location.href = 'HR-application.php'; sessionStorage.setItem('application_id', name)" class="btn btn-primary">View Application</button></td>
                          <!-- <td>
>>>>>>> Stashed changes:php/HR-role-listing-info.php
                            <div class="dropdown">
